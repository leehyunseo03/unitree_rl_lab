...
/isaac-sim/python.sh scripts/rsl_rl/play.py \
  ...
  --checkpoint /workspace/unitree_rl_lab/logs/rsl_rl/unitree_g1_29dof_velocity_backpack/2026-07-01_13-54-00/model_49999.pt \
  --num_envs 1 \
  --headless \
  --export-only
```
...
LIVESTREAM=2 /isaac-sim/python.sh scripts/rsl_rl/play_onnx.py \
    --task Unitree-G1-29dof-Velocity-Backpack \
    --policy /workspace/unitree_rl_lab/logs/rsl_rl/unitree_g1_29dof_velocity_backpack/2026-07-01_13-54-00/exported/policy.onnx \
    --lin-vel-x 0.4 \
    --real-time \
    --livestream 2
```
...
python scripts/rsl_rl/train.py \
  ...
  --run_name g1_29dof_velocity_backpack_50k
```
